...
@Component({
  selector: 'app-dispached',
  templateUrl: './dispached.component.html',
  styleUrls: ['./dispached.component.scss']
})
export class DispachedComponent implements OnInit {
    ...
    rejectAcceptShipment(element) {
        ...
        this.restService.updateShipmentStatus(this.pagination).then((res) => {
